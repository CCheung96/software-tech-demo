...
## Installing Required Libraries/Tools
...
![New Cyberduck Window]({{ site.baseurl }}/assets/imgs/research-machine-learning/setup/cyberduck-new.png)
...
![New Cyberduck Connection]({{ site.baseurl }}/assets/imgs/research-machine-learning/setup/cyberduck-new-connection.png)
...
![Cyberduck Connection Settings]({{ site.baseurl }}/assets/imgs/research-machine-learning/setup/cyberduck-connection-settings.png)
...
You may have noticed we use Terminal a lot within this project. If you have not used a terminal much in the past, we recommend you make [this worksheet](https://medium.com/@grace.m.nolan/terminal-for-beginners-e492ba10902a) your next stop. After that, move on to [Getting the Code]({{ site.baseurl }}/research/machine-learning/getting-code).
