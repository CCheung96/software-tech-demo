...
![Git Ways of Getting Code Diagram]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/getting-code.png)
...
* **Cloning Repositories**: Cloning a repository creates a remote copy of all the source code in a repository on your device. You can clone a repository that is no longer associated with the main repository, and is just a series of files. You would clone a repository if you want a copy of the repository without the version history.
...
### What is Cloning?
![Cloning Diagram]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/cloning.jpg)
...
Before you get started, make sure you have completed the [Setup Worksheet]({{ site.baseurl }}/research/machine-learning/setup) as well as the following tasks:
...
![Forking Screenshot]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/forking.png)
...
![Collaboration 1 Screenshot]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/collab-1.png)
2. Enter all your group members email addresses. Make sure you give them "write" privileges
![Collaboration 2 Screenshot]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/collab-2.png)
...
2. Enter the following git command: `git clone <YOUR-FORKED-REPOSITORY-LINK>`.
 ...
 ![Post-Clone]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/post_clone.png)
...
![Look Inside]({{ site.baseurl }}/assets/imgs/research-machine-learning/getting-code/look_inside.png)
