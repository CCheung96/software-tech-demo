...
![Git Workflow Diagram]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/git-workflow.jpg)
...
![Staged vs Unstaged Screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/un-staged.png)

### Stashing
![Stashing Diagram]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/git-stash.png)
...
![Merge Conflict Example Diagram]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/merge-conflict.png)
...
{: .note}
It is important that you check your change is successful before you continue/make a commit. So if your aim was to make a line thicker, make sure the line is ACTUALLY thicker. You only want to update your repository when you have made a positive change and not introduced any bugs.

The following video shows an example of how to find, make and commit a change

{% include youtube.html id="b1bi4H0e_KA" %}
...
![git status screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-2.png)
...
![git diff screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-3.png)
...
![git add all screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-4.1.png)
![git add screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-4.2.png)
...
![git commit screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-6.png)

7. Run `git status` and you should see your staged changes section is clear (all staged changes were included in the commit).
![git status2 screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-7.png)
...
![git log screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/commit-8.png)
...
![git log2 screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/just-commits.png)
...
![git log3 screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/push-1.png)
...
![git push screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/push-2.png)

3. Run `git log` and the origin should match up with the head.
![git log4 screenshot]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/push-3.png)
...
![Fetch VS Pull]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/fetch-vs-pull.jpg)
...
![Merge Conflict1]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/pull-2.1.png)

2. If you are using a Pi, open the conflicted file in nano. Otherwise, open it in Visual Studio
![Merge Conflict2]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/pull-2.2.png)
...
![Merge Conflict3]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/pull-2.5.png)

4. Once you've done this, treat the change as a normal commit:
`git add <FILE-NAME> && git commit -m "<COMMIT-MESSAGE>"`
![Merge Conflict4]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/pull-2.6.png)
![Merge Conflict5]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/pull-2.7.png)
...
3. You have some staged or unstaged changes on your local repository
  ...
  * Run `git stash pop <STASH-HASH>` to see if you can merge without a conflict, if there's a conflict a similar error will appear:
  ![Merge Conflict6]({{ site.baseurl  }}/assets/imgs/research-mini-console/changing-code/pull-3.png)
