...
![Git Ways of Getting Code Diagram]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/getting-code.png)

<img src="{{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/getting-code.png" alt="Git Ways of Getting Code Diagram"/>
...
### What is Cloning?
![Cloning Diagram]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/cloning.jpg)
...
![Forking Screenshot]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/forking.png)
...
![Collaboration 1 Screenshot]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/collab-1.png)
2. Enter all your group members email addresses. Make sure you give them "write" privileges
![Collaboration 2 Screenshot]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/collab-2.png)
...
![Remote Origin Diagram]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/remote-origins.jpg)
...
2. Enter the following git command: `git remote -v`.
 ...
 ![git remote screenshot]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/clone-1.png)
...
![git remote2 screenshot]({{ site.baseurl }}/assets/imgs/research-mini-console/getting-code/clone-2.png)
