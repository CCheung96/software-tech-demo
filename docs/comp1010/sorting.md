...
1. improves the efficiency of several tasks
2. makes several other non-trivial tasks trivial
...
{: .highlight}
Bottom line, **sorting is good**; it makes things MUCH easier!
...
[TreeSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/TreeSort.java){:target="_blank"}.
...
See [InsertionSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/InsertionSort.java){:target="_blank"} for a simple implementation.
...
The code in [SelectionSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/SelectionSort.java){:target="_blank"} implements this approach.
...
Yet another version of selection sort sorts in descending order, starting the sorting process from right to left.
...
[BubbleSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/BubbleSort.java){:target="_blank"} for a demonstration.

### Quick Sort

Quick sort works by choosing a pivot, placing smaller values before the pivot and
larger values after it, and then recursively sorting the two partitions.  A simple implementation is provided in
[QuickSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/QuickSort.java){:target="_blank"}.
...
A straightforward implementation can be found in [DoublePivotQuickSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/DoublePivotQuickSort.java){:target="_blank"}.
...
Sleep sort launches a thread for each value and relies on the operating system's timing to print numbers in order. It's more of a curiosity than a practical algorithm.  The code in [SleepSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/SleepSort.java){:target="_blank"} shows how it works.
...
Radix sort processes the digits of numbers one position at a time, allowing integers to be sorted in linear time when the number of digits is limited.  A full implementation appears in [RadixSort.java]({{ site.baseurl }}/assets/codes/comp1010/sorting/RadixSort.java){:target="_blank"}.
